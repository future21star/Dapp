...
class TrusteePickModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#trustee_pick_modal').modal('show');
		}
		else {
			$('#trustee_pick_modal').modal('hide');
		}
	}
	...
	render() {
		return (
			<div className="modal fade pop_sell pop_pick_sell" id="trustee_pick_modal" role="dialog">
				...
				<g id="Web-Application" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div className="btn_step_all">
						...
						<a href="#" className="a_prev">Finished</a>
					</div>
				  </div>
...
TrusteePickModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default TrusteePickModal;
