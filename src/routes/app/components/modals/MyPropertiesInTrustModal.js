...
class MyPropertiesInTrustModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#my_properties_in_trust_modal').modal('show');
		}
		else {
			$('#my_properties_in_trust_modal').modal('hide');
		}
	}
	...
	render() {
		return (
			<div className="modal fade pop_sell pop_sell_discription pop_chat_modal" id="my_properties_in_trust_modal" role="dialog">
							...
							<div className="profile_content_right">
								<div className="p_three_col">
									...
									<div className="status_d">
										...
										<p className="paragraph_p">In Trust</p>
									</div>
									<div className="add_d">
...
MyPropertiesInTrustModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default MyPropertiesInTrustModal;
