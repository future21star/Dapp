...
class DissolveTrustPopDissolveModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#dissolve_trust_pop_dissolve_modal').modal('show');
		}
		else {
			$('#dissolve_trust_pop_dissolve_modal').modal('hide');
		}
	}
	...
	render() {
		return (
		<div className="modal fade pop_sell pop_warning" id="dissolve_trust_pop_dissolve_modal" role="dialog">
		...
		<svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		    ...
		    <g id="Web-Application" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				<div className="modal_custom">
					<p className="para_legal para_approval_request">If you dissolve this trust the property will be deeded back to you! Are you sure you want to do this?</p>
				</div>
				<div className="btn_step_all">
					<a href="#" className="a_back">Back</a>
					<a href="#" className="a_prev">Yes, Dissolve Trust</a>
				</div>
		      </div>
...
DissolveTrustPopDissolveModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default DissolveTrustPopDissolveModal;
