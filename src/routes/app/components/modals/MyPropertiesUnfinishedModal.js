...
class MyPropertiesUnfinishedModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#my_properties_unfinished_modal').modal('show');
		}
		else {
			$('#my_properties_unfinished_modal').modal('hide');
		}
	}
	...
	render() {
		return (
			<div className="modal fade pop_sell pop_sell_discription pop_chat_modal" id="my_properties_unfinished_modal" role="dialog">
