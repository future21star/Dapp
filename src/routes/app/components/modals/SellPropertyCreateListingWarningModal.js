...
class SellPropertyCreateListingWarningModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#sell_property_create_listing_warning_modal').modal('show');
		}
		else {
			$('#sell_property_create_listing_warning_modal').modal('hide');
		}
	}
			...
			<svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			    ...
			    <g id="Web-Application" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div className="modal_custom">
						<p className="para_legal para_approval_request">You are listing your property for sale. If someone clicks on the buy button then the transaction will be done. This decision is final.</p>
					</div>
...
SellPropertyCreateListingWarningModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default SellPropertyCreateListingWarningModal;
