...
class MyPropertiesForSaleModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#my_properties_for_sale_modal').modal('show');
		}
		else {
			$('#my_properties_for_sale_modal').modal('hide');
		}
	}
	...
	render() {
		return (
			<div className="modal fade pop_sell pop_sell_discription pop_chat_modal" id="my_properties_for_sale_modal" role="dialog">
			...
			<svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			    ...
			    <g id="Web-Application" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div className="profile_content_right">
								<div className="p_three_col">
									...
									<div className="status_d">
										<h6 className="head_h">Status:</h6>
										<p className="paragraph_p">On Market</p>
									</div>
									<div className="add_d">
					...
					<div className="btn_flow r_flow_set_mobile">
						<div className="l_flow">
							<a href="#">Back</a>
						</div>
						<div className="r_flow ">
							<a href="#">Dissolve Trust</a>
				...
				<div className="modal-dialog">
			<div className="forth_left_listing" style="
			">
...
MyPropertiesForSaleModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default MyPropertiesForSaleModal;
