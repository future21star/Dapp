...
class TrusteeConfirmModal extends Component {
	componentWillReceiveProps(nextProps) {
		if(nextProps.show) {
			$('#trustee_confirm_modal').modal('show');
		}
		else {
			$('#trustee_confirm_modal').modal('hide');
		}
	}
	...
	render() {
		return (
		<div className="modal fade pop_sell pop_trustee_confirm" id="trustee_confirm_modal" role="dialog">
		...
		<svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xlinkHref='http://www.w3.org/1999/xlink'>
		    ...
		    <g id="Web-Application" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
				...
				<div className="modal_custom">
					<p className="para_legal para_approval_request">Cangrats! Your property will be on the blockchain in just a few days.</p>
				</div>
...
TrusteeConfirmModal.propTypes = {
  show: PropTypes.bool,
  goToStep: PropTypes.func
};

export default TrusteeConfirmModal;
